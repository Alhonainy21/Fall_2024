#!/bin/bash                                                                                                                                      
MEM_LOGFILE="memory_10Sclient6.csv"                                                                                                              
SERVER_LOGFILE="normal_10Scli_lung3_client_6.txt"
...
while true; do                                                                                                                                   
    ...
    rclone copy "$MEM_LOGFILE" gdrive:Chameleon/Memory_10cli --update                                                                            
    # Sync server log file to Google Drive folder for server logs                                                                                
    rclone copy "$SERVER_LOGFILE" gdrive:Chameleon/Logs_10cli --update                                                                           
